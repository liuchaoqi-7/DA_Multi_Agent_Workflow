...
[![Star History Chart](https://api.star-history.com/svg?repos=<liuchaoqi-7>/DA-Multi_Agent_Workflow&type=Date)](https://star-history.com/#<liuchaoqi-7>/DA-Multi_Agent_Workflow&Date)
...
| 指标 | 数值 | 说明 |
|------|------|------|
| 日均数据采集量 | 100万+ 条 | 四平台订单+售后+结算+投放+罗盘榜单数据 |
...
| 维度 | 传统 Cron 、 EVENT 调度 | 本项目 Master-Sub 架构 |
|------|----------------|------------------------|
...
> 💡 **数据分析 Agent 示例截图**：
![数据分析Agent使用示例](docs/images/agent使用示例.png)
...
| `ods_千川素材_视频_m` | 千川素材投放分钟数据 | 千川API | ODS |
| `ods_千川素材_其他_m` | 千川其他创意分钟数据 | 千川API | ODS |
| `ods_直播数据minute_v2` | 店铺直播分钟数据 | 抖店网页 | ODS |
| `ods_主播排期表` | 店铺主播排期数据 | 飞书多维表 | ODS |
| `ods_达人榜单_day` | 电商罗盘达人榜单天数据 | 电商罗盘网页 | ODS |
| `ods_店铺榜单_day` | 电商罗盘店铺榜单天数据 | 电商罗盘网页 | ODS |
| `ods_搜索榜单_day` | 电商罗盘搜索榜单天数据 | 电商罗盘网页 | ODS |
| `ods_商品榜单_day` | 电商罗盘商品榜单天数据 | 电商罗盘网页 | ODS |
| `ods_内容榜_视频销量榜_day` | 电商罗盘内容榜单销量天数据 | 电商罗盘网页 | ODS |
| `ods_内容榜_引流直播榜_day` | 电商罗盘内容榜单引流天数据 | 电商罗盘网页 | ODS |
| `ods_内容榜_直播交易榜_day` | 电商罗盘商品榜单交易天数据 | 电商罗盘网页 | ODS |
| `ods_达人信息_主表` | 精选联盟达人基础信息+评分+匹配度+内容+带货数据 | 精选联盟网页 | ODS |
| `ods_达人信息_粉丝画像` | 精选联盟达人粉丝画像 | 精选联盟网页 | ODS |
| `ods_达人信息_商品流水` | 精选联盟达人带货商品销售数据 | 精选联盟网页 | ODS |
| `ods_达人信息_直播流水` | 精选联盟达人带货直播交易数据 | 精选联盟网页 | ODS |
| `dwd_千川_素材m` | 千川素材分钟拼接数据 | SQL建模 | DWD |
| `dwd_千川_素材h` | 千川视频小时聚合数据关联千川财务数据 | SQL建模 | DWD |
| `dwd_抖店_宽表` | 抖店订单+售后+结算数据 | SQL建模 | DWD |
| `dwd_红书_宽表` | 小红书订单+售后+结算数据 | SQL建模 | DWD |
| `dwd_微信_宽表` | 微信小店订单+售后+结算数据 | SQL建模 | DWD |
| `dwd_电商数据_宽表` | 三个平台订单合并宽表 | SQL建模 | DWD |
| `dim_达人维度` | 订单达人维度表 | SQL建模 | DIM |
| `dim_商品维度` | 订单商品维度表 | SQL建模 | DIM |
| `dim_达人榜单` | 榜单达人维度表 | SQL建模 | DIM |
| `dim_sys_metadata_dict` | 🌟 全域数据字典表 | 自动采集 | DIM |
| `ads_千川素材_直播画面_m` | 店铺主播直播+投放+订单数据 | SQL建模 | ADS |
| `ads_达人专场_分时段效果监控` | 达人直播专场实时监控视图 | SQL建模 | ADS |
